...
`ro_forecasts`. Every forecast carries evidence (band + trend fit); **no accuracy/lead-time claims
...
| IV — measured/modeled labels; evidence on every output (FR-002/003/006) | ⚠️ band present; explicit CI bounds + named drivers = task T-004b |
